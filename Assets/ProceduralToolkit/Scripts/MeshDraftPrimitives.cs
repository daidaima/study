...
namespace ProceduralToolkit
{
    ...
    public partial class MeshDraft
    {
        ...
        {
            return Hexahedron(Vector3.zero, Vector3.right*width, Vector3.forward*length, Vector3.up*height, generateUV);
        }

        /// <summary>
        /// Constructs a hexahedron draft
        /// </summary>
        public static MeshDraft Hexahedron(Vector3 origin,Vector3 width, Vector3 length, Vector3 height, bool generateUV = true)
        {
